...
//            默认是classPath路径
    ...
    public static String getFileKey(String name) {
        ...
        if (!new File(TaleUtils.CLASSPATH + prefix).exists()) {
            new File(TaleUtils.CLASSPATH + prefix).mkdirs();
        }
